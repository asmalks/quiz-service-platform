            ...
            <Card className="w-full max-w-md shadow-2xl transition-all duration-300 hover:shadow-glow" style={{ borderColor: theme.primary_color, borderWidth: "2px" }}>
                <CardHeader className="text-center space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-2 sm:gap-3 pt-4">
                        <div className="text-center p-2 sm:p-3 rounded-lg bg-blue-50 border border-blue-100 transition-all duration-300 hover:scale-105 hover:bg-blue-100 hover:shadow-md cursor-pointer group">
                            <Brain className="w-4 h-4 sm:w-5 sm:h-5 mx-auto mb-1 transition-transform duration-300 group-hover:scale-110" style={{ color: theme.primary_color }} />
                        ...
                        <div className="text-center p-2 sm:p-3 rounded-lg bg-purple-50 border border-purple-100 transition-all duration-300 hover:scale-105 hover:bg-purple-100 hover:shadow-md cursor-pointer group">
                            <Clock className="w-4 h-4 sm:w-5 sm:h-5 mx-auto mb-1 text-accent transition-transform duration-300 group-hover:scale-110" />
                        ...
                        <div className="text-center p-2 sm:p-3 rounded-lg bg-emerald-50 border border-emerald-100 transition-all duration-300 hover:scale-105 hover:bg-emerald-100 hover:shadow-md cursor-pointer group">
                            <Users className="w-4 h-4 sm:w-5 sm:h-5 mx-auto mb-1 transition-transform duration-300 group-hover:scale-110" style={{ color: theme.secondary_color }} />
